...
pool = ConnectionPool(
    host=os.environ.get('REDIS_HOST', 'redis'), port=int(os.environ.get('REDIS_PORT', 6379)), max_connections=20
)
HUEY = PriorityRedisExpireHuey(
    name='huey_monitor_project',  # Just the name for this task queue.
