...
ROOT_URLCONF = 'huey_monitor_project.test_project.urls'
WSGI_APPLICATION = 'huey_monitor_project.test_project.wsgi.application'
...
USE_L10N = True
USE_TZ = True
LOCALE_PATHS = (str(BASE_DIR / 'huey_monitor' / 'locale'),)
...
LOGGING = {
    ...
    'formatters': {
        'colored': {
            ...
            'format': (
                '{log_color}{asctime} {levelname}' ' PID:{process} {threadName} {name} {module}.{funcName} {message}'
            ),
            'style': '{',
        }
    },
    ...
    'loggers': {
        ...
        'huey_monitor_project': {'handlers': ['console'], 'level': 'DEBUG', 'propagate': False},
    },
}
